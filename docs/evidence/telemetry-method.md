...
There is no CPU throttling or deliberate load. This is a headless functional check and does not claim monitor frequency, a new performance benchmark, or a repeat of the three lab experiments. The extension source and these observations are versioned together.
